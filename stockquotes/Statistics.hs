...
daysBetween :: (Num b, Foldable t) => QField -> t QuoteData -> b
...
funcByField :: Functor f => (f Fixed4 -> c) -> QField -> f QuoteData -> c
funcByField func qf = func . fmap (field2fun qf)

computeStatistic
  :: (Functor t, Foldable t) => Statistic -> QField -> t QuoteData -> Fixed4
